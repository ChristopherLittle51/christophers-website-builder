...
export const portfolioComponents: Record<string, any> = {
  SplitFeature: {
  ...
  ProjectGrid: {
        label: 'Two project cards', fields: { number: { type: 'text', label: 'Section number' }, title: { type: 'text', label: 'Section title', contentEditable: true }, intro: { type: 'textarea', label: 'Introduction', contentEditable: true }, titleFont: fontField('Title font'), introFont: fontField('Introduction font'), image1: imageField('First project image'), image1Crop: cropField('First image crop'), image1Alt: { type: 'text', label: 'First image description' }, title1: { type: 'text', label: 'First project title', contentEditable: true }, url1: { type: 'text', label: 'First project link' }, image2: imageField('Second project image'), image2Crop: cropField('Second image crop'), image2Alt: { type: 'text', label: 'Second image description' }, title2: { type: 'text', label: 'Second project title', contentEditable: true }, url2: { type: 'text', label: 'Second project link' }, theme: { type: 'radio', label: 'Theme', options: themeOptions } },
        defaultProps: { number: '001', title: 'Selected projects', intro: 'A few recent stories.', titleFont: 'inherit', introFont: 'inherit', image1: '/images/reel-cinematography.jpg', image1Crop: 'center center', image1Alt: 'Project one preview', title1: 'Project one', url1: '#', image2: '/images/reel-editing.jpg', image2Crop: 'center center', image2Alt: 'Project two preview', title2: 'Project two', url2: '#', theme: 'paper' },
        render: ({ number, title, intro, titleFont, introFont, image1, image1Crop, image1Alt, title1, url1, image2, image2Crop, image2Alt, title2, url2, theme }) => <section className={`builder-projects builder-theme--${theme}`}><div className="builder-section-title"><div><span>{number}</span><h2 style={fontStyle(titleFont)}>{title}</h2></div><p style={fontStyle(introFont)}>{intro}</p></div><div className="builder-projects__grid">{[{ image: image1, crop: image1Crop, alt: image1Alt, title: title1, url: url1 }, { image: image2, crop: image2Crop, alt: image2Alt, title: title2, url: url2 }].map((project, index) => <a href={project.url} key={`${project.title}-${index}`}><div><img src={project.image} alt={project.alt || ''} style={imagePosition(project.crop)} /><span className="builder-play" aria-hidden="true">▶</span></div><strong>{project.title}</strong><span>View project ↗</span></a>)}</div></section>,
  },
  GalleryBlock: {
        label: 'Six-image gallery', fields: { number: { type: 'text', label: 'Section number' }, title: { type: 'text', label: 'Title', contentEditable: true }, intro: { type: 'textarea', label: 'Introduction', contentEditable: true }, titleFont: fontField('Title font'), introFont: fontField('Introduction font'), image1: imageField('Image 1'), image1Crop: cropField('Image 1 crop'), image1Alt: { type: 'text', label: 'Image 1 description' }, image2: imageField('Image 2'), image2Crop: cropField('Image 2 crop'), image2Alt: { type: 'text', label: 'Image 2 description' }, image3: imageField('Image 3'), image3Crop: cropField('Image 3 crop'), image3Alt: { type: 'text', label: 'Image 3 description' }, image4: imageField('Image 4'), image4Crop: cropField('Image 4 crop'), image4Alt: { type: 'text', label: 'Image 4 description' }, image5: imageField('Image 5'), image5Crop: cropField('Image 5 crop'), image5Alt: { type: 'text', label: 'Image 5 description' }, image6: imageField('Image 6'), image6Crop: cropField('Image 6 crop'), image6Alt: { type: 'text', label: 'Image 6 description' } },
        ...
        render: ({ number, title, intro, titleFont, introFont, image1, image1Crop, image1Alt, image2, image2Crop, image2Alt, image3, image3Crop, image3Alt, image4, image4Crop, image4Alt, image5, image5Crop, image5Alt, image6, image6Crop, image6Alt }) => <section className="builder-gallery"><div className="builder-section-title"><div><span>{number}</span><h2 style={fontStyle(titleFont)}>{title}</h2></div><p style={fontStyle(introFont)}>{intro}</p></div><div className="builder-gallery__grid">{[[image1, image1Crop, image1Alt], [image2, image2Crop, image2Alt], [image3, image3Crop, image3Alt], [image4, image4Crop, image4Alt], [image5, image5Crop, image5Alt], [image6, image6Crop, image6Alt]].map(([image, crop, alt], index) => <img src={image} alt={alt || ''} style={imagePosition(crop)} key={`${image}-${index}`} />)}</div></section>,
  },
  BeforeAfter: {
