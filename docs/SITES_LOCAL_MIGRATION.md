...
3. Open `/migration-export` on the same origin. It loads the authenticated manifest for inspection and links to `/api/export?download=1` for saving the JSON response.
